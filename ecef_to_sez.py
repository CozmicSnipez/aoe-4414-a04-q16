...
#  x_km: ECEF X-coordinate of the position in km
#  y_km: ECEF Y-coordinate of the position in km
#  z_km: ECEF Z-coordinate of the position in km
# Output:
...
# Helper function to convert from ECEF to SEZ using the updated lat/lon from LLH
